...
3. Add C++17 extractor target, LLVM 17 package discovery, the selected frontend API, and argument/diagnostic plumbing for one record.
4. Add the structured type graph, declaration identity, source/file/include model, and serializer.
