...
The core structural-model increment is also implemented. Next extend namespace
and anonymous declaration identity/source coverage, while obtaining actual legacy
