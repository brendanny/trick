...
DEC-01's final supported combinations remain open for B6; Python 2 discovery is
implemented but unqualified in this layer. The imported `Trick::Python` alias
