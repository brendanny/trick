---
title: "Trick CheckPointing Best Practices"
...
* If [I/O specification](../tutorial/ATutAnalyticSim.md#the-inputoutput-io-specification) of a data member is ```**``` then it will not be saved in a checkpoint. 
