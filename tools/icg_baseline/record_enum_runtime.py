#!/usr/bin/env python3
"""Round-trip generated ordinary enum fields through the real MemoryManager."""
...
import native
import record_enum_metadata as enums
...
def mutations(candidate: str, probe: str) -> tuple:
    return (
        (
            ...
            candidate.replace(
                "return sizeof(::RecordState);", "return sizeof(short);", 1
            ),
            probe,
        ),
        (
            "checkpoint-array-disabled",
            re.sub(
                r'("states", "RecordState",[^}]*?\n  )15,TRICK_ENUMERATED',
