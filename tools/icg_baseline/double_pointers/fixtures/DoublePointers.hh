/* PURPOSE: (Double builtin pointer metadata and checkpoint conformance.) */
#ifndef ICG_BASELINE_DOUBLE_POINTERS_HH
#define ICG_BASELINE_DOUBLE_POINTERS_HH
using IntegerPointer = int**;
using PointerPair = IntegerPointer[2];
struct DoublePointerModel {
    bool** enabled;
    char** text;
